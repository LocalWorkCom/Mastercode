...
<section class="hero">
  ...
  <div class="container d-flex align-items-center justify-content-center ">
    <div class="row hero-content d-flex align-items-center justify-content-center">
      ...
      <div class="col-md-6">
        <img src="{{ $homeData && !empty($homeData->image_hero) ? $homeData?->image_hero : asset('assets/images/slider-img.png') }}" class="img-fluid" alt="img">
      </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="about-img-wrapper">
          <img src="{{ $homeData && !empty($homeData->image_features) ? $homeData?->image_features : asset('assets/images/about-img.png') }}" class="img-fluid" alt="img">
        </div>
      </div>
...
<section class="partners-section">
  <div class="container ">
    ...
    <div class="partners-logos d-flex justify-content-between flex-wrap align-items-center">
      <img src="{{ $homeData && !empty($homeData->image_partner[0]) ? $homeData?->image_partner[0] : asset('assets/images/electron.png') }}" alt="Partner 1">
      <img src="{{ $homeData && !empty($homeData->image_partner[1]) ? $homeData?->image_partner[1] : asset('assets/images/elkoot.png') }}" alt="Partner 2">
      <img src="{{ $homeData && !empty($homeData->image_partner[2]) ? $homeData?->image_partner[2] : asset('assets/images/saeeh.png') }}" alt="Partner 3">
      <img src="{{ $homeData && !empty($homeData->image_partner[3]) ? $homeData?->image_partner[3] : asset('assets/images/tamweel.png') }}" alt="Partner 4">
    </div>
  </div>
</section>
