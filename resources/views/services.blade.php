        ...
        <div class="container">
            <div class="row align-items-center my-md-5 mb-1">
                <div class="col-md-6">
                    <div class="item d-flex align-items-start gap-2 mb-md-5 mb-2">
                        ...
                        <h4 class="text-blue fw-bold mb-0  lh-base">Digitally replaces printed order tickets in the kitchen.
                        </h4>
                    </div>
                    <div class="item d-flex align-items-start gap-2 mb-md-5 mb-2">
                        <i class="fa-solid fa-circle-check text-success mt-1 fs-5"></i>
                        <h4 class="text-blue fw-bold mb-0  lh-base">The cashier or point of sale ( POS ) system is the
                            operational care taking and payment processing. </h4>
                    </div>
                    <div class="item d-flex align-items-start gap-2 mb-md-5 mb-2">
                        <i class="fa-solid fa-circle-check text-success mt-1 fs-5"></i>
                        <h4 class="text-blue fw-bold mb-0  lh-base">A mobile - based - solution enabling waitstaff to manage
                            orders , tables , customer requests efficiently.</h4>
                    </div>
                </div>

                <div class="col-md-6 d-flex justify-content-end">
                    <img src="./assets/images/services-img1.png" alt="" class="img-fluid h-100 w-100">
                </div>
            </div>
            <div class="terms-page-img">
                ...
                <div class="row align-items-center my-md-5 mb-1">
                    <div class="col-md-6 mt-md-5 mt-0">
                        <img src="./assets/images/services-img2.png" alt="" class="img-fluid h-100 w-100">
                    </div>
                    <div class="col-md-6 mt-md-5 mt-0">
                        <h4 class="text-blue lh-base">A well-implemented ERP system eliminates data silos, enhances
            ...
            <div class="row align-items-center my-md-5 mb-1">
                ...
                <div class="col-md-4 mt-md-5 mt-0">
                    <img src="./assets/images/services-img3.png" alt="" class="img-fluid h-100 w-100">
                </div>
            </div>
        </div>
    </section>
