        ...
        <div class="row d-flex flex-wrap  justify-content-center align-items-center">
            ...
            <div class="col-md-6">
                <div class="video-box position-relative mx-auto my-5">
                    <img src="./assets/images/aboutus-img1.jpg" class="img-fluid main-img">
...
<section class="timeline-mobile d-block d-md-none py-4">
    ...
    <div class="container">
        ...
        <div class="mobile-card">
            <h4 class="year text-green fw-bold text-center">2022</h4>
            <p>We launched Master Code with our first product – a simple app to streamline local businesses</p>
        </div>

        <div class="mobile-card">
            <h4 class="year text-green fw-bold text-center">2023</h4>
            <p>Expanded our services to include ERP systems and cloud solutions</p>
        </div>

        <div class="mobile-card">
            <h4 class="year text-green fw-bold text-center">2024</h4>
            <p>Delivered our first large-scale ERP project for a restaurant business, integrating POS, HR, and inventory modules</p>
        </div>

        <div class="mobile-card">
            <h4 class="year text-green fw-bold text-center">2025</h4>
            <p>Introduced AI-powered tools and machine-learning solutions in our portfolio, enabling predictive analytics</p>
        </div>
        ...
        <div class="row mb-5">
            <div class="col-md-4">
                <div class="d-flex flex-wrap  justify-content-center border-start ">
                    ...
                    <div class="content">
                        <h2 class="fw-bold">Innovation</h2>
                        <h4 class="text-muted">We constantly explore new technologies (AI, cloud, mobile) to build
                            future-ready solutions</h4>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="d-flex flex-wrap  justify-content-center border-start ">
                    ...
                    <div class="content">
                        <h2 class="fw-bold">Integrity</h2>
                        <h4 class="text-muted">Transparency and honesty are at the heart of how we work with our
                            clients</h4>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="d-flex flex-wrap  justify-content-center  ">
                    ...
                    <div class="content">
                        <h2 class="fw-bold">Customer-Centricity</h2>
                        <h4 class="text-muted">Transparency and honesty are at the heart of how we work with our
                            clients</h4>
                    </div>
                </div>
        ...
        <div class="row d-flex flex-wrap  justify-content-center">
            <div class="col-md-4">
                <div class="d-flex flex-wrap  justify-content-center  ">
                    ...
                    <div class="content">
                        <h2 class="fw-bold">Collaboration</h2>
                        <h4 class="text-muted">Great software comes from strong teamwork — between us and with you
                        </h4>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="d-flex flex-wrap  justify-content-center border-end ">
                    ...
                    <div class="content">
                        <h2 class="fw-bold">Excellence</h2>
                        <h4 class="text-muted">We don’t settle for “good enough”; we aim for flawless performance,
                            security, and scalability</h4>
                    </div>
                </div>
...
<section class="team-section py-5">
    ...
    <div class="team-wrapper" id="teamSlider">
        ...
        <div class="team-item">
            <img src="./assets/images/women1.jpg" alt="">
        </div>
